      ...
      <v-row>
        <v-col cols="12" class="text-left">
          <v-tooltip bottom>
            ...
            <span>پاک کردن گروهی فرودگاه ها</span>
          </v-tooltip>
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
        ...
        <v-col cols="12">
          <v-data-table
              ...
              :items="airports.data"
              :items-per-page="airports.per_page"
              :footer-props="{ itemsPerPageOptions: [5, 10, 25, 50] }"
              :server-items-length="airports.total"
              :fixed-header="true"
              item-value="index"
              :loading="loading"
          >
        ...
        <v-card-text>
          <v-row>
            <v-col cols="12" class="text-dialog-title">
              آیا از پاک کردن فرودگاه اطمینان دارید ؟
            </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        {text: 'شناسه', value: 'id', align: 'center', width: '5%', show: true, sortable: true},
        {text: 'نام انگلیسی', value: 'en_name', align: 'center', width: '8%', show: true, sortable: true},
        {text: 'نام فارسی', value: 'fa_name', align: 'center', width: '8%', show: true, sortable: true},
        {text: 'شهر', value: 'city', align: 'center', width: '7%', show: true, sortable: true},
        {text: 'کشور', value: 'country', align: 'center', width: '6%', show: true, sortable: true},
        {text: 'نام انگلیسی شهر', value: 'city_en', align: 'center', width: '8%', show: true, sortable: true},
        {text: 'کد کشور', value: 'country_code', align: 'center', width: '5%', show: true, sortable: true},
        {text: 'نوع', value: 'type', align: 'center', width: '8%', show: true, sortable: true},
        {text: 'کد فرودگاه', value: 'airport_code', align: 'center', width: '8%', show: true, sortable: true},
        {text: 'مبدا؟', value: 'is_origin', align: 'center', width: '6%', show: true, sortable: true},
        {text: 'مقصد؟', value: 'is_destination', align: 'center', width: '6%', show: true, sortable: true},
        {text: 'هتل', value: 'has_hotel', align: 'center', width: '2%', show: true, sortable: true},
        {text: 'CIP', value: 'has_cip', align: 'center', width: '2%', show: true, sortable: true},
        {text: 'ورودی پرواز داخلی', value: 'has_cip_domestic_enter', align: 'center', width: '3%', show: true, sortable: true},
        {text: 'خروجی پرواز داخلی', value: 'has_cip_domestic_exit', align: 'center', width: '3%', show: true, sortable: true},
        {text: 'ورودی  پرواز خارجی', value: 'has_cip_foreign_enter', align: 'center', width: '3%', show: true, sortable: true},
        {text: 'خروجی پرواز خارجی', value: 'has_cip_foreign_exit', align: 'center', width: '3%', show: true, sortable: true},
        {text: 'وضعیت', value: 'status', align: 'center', width: '6%', show: true, sortable: true},
        {
          text: 'زمان ثبت',
          value: 'created_at_fa',
  ...
  methods: {
    ...
    create() {
      this.$router.push('/airport/create')
    },
    edit(entityID) {
