      ...
      <v-row>
        <v-col cols="12" class="text-left">
          <v-tooltip bottom>
            ...
            <span>پاک کردن گروهی  فرم های تماس با ما</span>
          </v-tooltip>
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
        ...
        <v-col cols="12">
          <v-data-table
              ...
              :items="contactUsForms.data"
              :items-per-page="contactUsForms.per_page"
              :footer-props="{ itemsPerPageOptions: [5, 10, 25, 50] }"
              :server-items-length="contactUsForms.total"
              :fixed-header="true"
              item-value="index"
              :loading="loading"
          >
        ...
        <v-card-text>
          <v-row>
            <v-col cols="12" class="text-dialog-title">
              آیا از پاک کردن این فرم تماس با ما اطمینان دارید ؟
            </v-col>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: 'نام', value: 'full_name', align: 'center', width: '20%',show: true,sortable:true},
        {text: 'موبایل', value: 'mobile', align: 'center', width: '20%',show: true,sortable:true},
        {text: 'موضوع', value: 'subject', align: 'center', width: '20%',show: true,sortable: true},
        {text: 'ایمیل', value: 'email', align: 'center', width: '20%',show: true,sortable: true},
        {
          text: 'زمان ثبت',
          value: 'created_at_fa',
