      ...
      <v-row>
        <v-col cols="12" class="text-left">
          <v-tooltip bottom>
            ...
            <span>پاک کردن گروهی کارت های معرفی</span>
          </v-tooltip>
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
          ...
          <v-tooltip bottom>
            ...
            <span>ساخت کارت معرفی جدید</span>
          </v-tooltip>
        </v-col>
        <v-col cols="12">
          <v-data-table
              ...
              :items="promots.data"
              :items-per-page="promots.per_page"
              :footer-props="{ itemsPerPageOptions: [5, 10, 25, 50] }"
              :server-items-length="promots.total"
              :fixed-header="true"
              item-value="index"
              :loading="loading"
             >
        ...
        <v-card-text>
          <v-row>
            <v-col cols="12" class="text-dialog-title">
              آیا از پاک کردن کارت های معرفی اطمینان دارید ؟
            </v-col>
      ...
      <v-card>
        <v-row justify="center" align="center" class="ma-0 pa-5">
          <v-col cols="12" class="text-center">
            آیا از پاک شدن تمام کارت های معرفی اطمینان دارید؟
          </v-col>
          <v-col cols="3"></v-col>
          <v-col cols="3">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: 'کاور', value: 'cover', align: 'center', width: '20%',show: true,sortable:true},
        {text: 'لینک', value: 'url', align: 'center', width: '20%',show: true,sortable:true},
        {text: 'اولویت', value: 'priority', align: 'center', width: '20%',show: true,sortable:true},
  ...
  methods: {
    ...
    create() {
      this.$router.push('/promot/create')
    },
    edit(entityID) {
